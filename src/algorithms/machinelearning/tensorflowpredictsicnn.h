...
#ifndef ESSENTIA_TENSORFLOWPREDICTSICNN_H
#define ESSENTIA_TENSORFLOWPREDICTSICNN_H
...
class TensorflowPredictSiCNN : public AlgorithmComposite {
 protected:
  Algorithm* _frameCutter;
  Algorithm* _tensorflowInputSiCNN;
...
// depends on it
class TensorflowPredictSiCNN : public Algorithm {
 protected:
  Input<std::vector<Real> > _signal;
  Output<std::vector<std::vector<Real> > > _predictions;

  streaming::Algorithm* _tensorflowPredictSiCNN;
...
#endif // ESSENTIA_TENSORFLOWPREDICTSICNN_H
