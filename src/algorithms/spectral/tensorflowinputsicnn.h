...
#ifndef ESSENTIA_TENSORFLOWINPUTSICNN_H
#define ESSENTIA_TENSORFLOWINPUTSICNN_H
...
class TensorflowInputSiCNN : public Algorithm {
 ...
 protected:
  ...
  // Windowing
  bool _normalizedWindowing = false;
  int _frameSize = 660;
  std::string _windoyType = "hamming";
  ...
  // MelBands
  int _numberBands = 96;
  Real _sampleRate = 22050.0;
  Real _lowFrequencyBound = 50.0;
  Real _highFrequencyBound = 10500.0;
  Real _eps = 1.1e-8;
...
class TensorflowInputSiCNN : public StreamingAlgorithmWrapper {
 ...
 public:
  TensorflowInputSiCNN() {
    declareAlgorithm("TensorflowInputSiCNN");
...
#endif // ESSENTIA_TENSORFLOWINPUTSICNN_H
